...
> = phf_map! {
		...
		UniCase::ascii("type::try_array") => (PathKind::Function, None),
		UniCase::ascii("type::try_bool") => (PathKind::Function, None),
		UniCase::ascii("type::try_bytes") => (PathKind::Function, None),
		...
		UniCase::ascii("type::try_int") => (PathKind::Function, None),
		UniCase::ascii("type::try_number") => (PathKind::Function, None),
		UniCase::ascii("type::try_point") => (PathKind::Function, None),
		UniCase::ascii("type::try_range") => (PathKind::Function, None),
		UniCase::ascii("type::try_record") => (PathKind::Function, None),
		UniCase::ascii("type::try_set") => (PathKind::Function, None),
		UniCase::ascii("type::try_string") => (PathKind::Function, None),
		UniCase::ascii("type::try_string_lossy") => (PathKind::Function, None),
		UniCase::ascii("type::try_table") => (PathKind::Function, None),
		UniCase::ascii("type::try_uuid") => (PathKind::Function, None),
