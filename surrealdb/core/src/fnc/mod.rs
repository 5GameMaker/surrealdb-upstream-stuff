...
pub fn synchronous(
	...
	dispatch!(
		...
		"type::try_array" => r#type::r#try::array,
		"type::try_bool" => r#type::r#try::bool,
		"type::try_bytes" => r#type::r#try::bytes,
		"type::try_datetime" => r#type::r#try::datetime,
		"type::try_decimal" => r#type::r#try::decimal,
		"type::try_duration" => r#type::r#try::duration,
		exp(Files) "type::try_file" => r#type::r#try::file,
		"type::try_float" => r#type::r#try::float,
		"type::try_geometry" => r#type::r#try::geometry,
		"type::try_int" => r#type::r#try::int,
		"type::try_number" => r#type::r#try::number,
		"type::try_point" => r#type::r#try::point,
		"type::try_range" => r#type::r#try::range,
		"type::try_record" => r#type::r#try::record,
		"type::try_set" => r#type::r#try::set,
		"type::try_string" => r#type::r#try::string,
		"type::try_string_lossy" => r#type::r#try::string_lossy,
		"type::try_table" => r#type::r#try::table,
		"type::try_uuid" => r#type::r#try::uuid,
	...
	match value {
		Value::Set(x) => {
			...
			dispatch!(
				...
				"to_uuid" => r#type::uuid,
				//
				"try_array" => r#type::r#try::array,
				"try_bool" => r#type::r#try::bool,
				"try_bytes" => r#type::r#try::bytes,
				"try_datetime" => r#type::r#try::datetime,
				"try_decimal" => r#type::r#try::decimal,
				"try_duration" => r#type::r#try::duration,
				"try_float" => r#type::r#try::float,
				"try_geometry" => r#type::r#try::geometry,
				"try_int" => r#type::r#try::int,
				"try_number" => r#type::r#try::number,
				"try_point" => r#type::r#try::point,
				"try_range" => r#type::r#try::range,
				"try_record" => r#type::r#try::record,
				"try_set" => r#type::r#try::set,
				"try_string" => r#type::r#try::string,
				"try_string_lossy" => r#type::r#try::string_lossy,
				"try_uuid" => r#type::r#try::uuid,
				//
